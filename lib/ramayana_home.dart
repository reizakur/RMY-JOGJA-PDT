    ...
    return RelativeBuilder(builder: (context, height, width, sy, sx) {
      return Scaffold(
        appBar: AppBar(
            ...
            backgroundColor: const Color.fromARGB(250, 236, 7, 7),
            actions: <Widget>[
              IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(context,
                      ...
                      return const Profilee();
                    }));
                  }),
              IconButton(
                  icon: const Icon(Icons.power_settings_new), onPressed: () {})
            ],
            elevation: 20,
            leading: IconButton(
          ...
          children: [
            ListView(
              children: [
                Container(
                  margin:
                      EdgeInsets.only(top: sy(75), left: sy(20), right: sy(20)),
                  height: sy(200),
                  width: sy(400),
                ...
                AnimatedOpacity(
                  ...
                  child: Container(
                    ...
                    margin: EdgeInsets.only(
                        top: sy(30), left: sy(70), right: sy(70)),
                    height: sy(50),
                    // width: sy(100),
                    decoration: BoxDecoration(
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    margin: EdgeInsets.only(
                        top: sy(10), left: sy(100), right: sy(100)),
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 255, 0, 0),
